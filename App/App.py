...
def run():
    ...
    link = '<b>Built by <a href="https://www.linkedin.com/in/s-bala-ganesh-1596332b1?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" style="text-decoration: none; color: #021659;">Bala Ganesh</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built by 
            <a href="https://www.linkedin.com/in/s-bala-ganesh-1596332b1?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" style="text-decoration: none; color: grey;">Bala Ganesh</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Bala ! Total %d " % values + " User's Have Used Our Tool : )")                
